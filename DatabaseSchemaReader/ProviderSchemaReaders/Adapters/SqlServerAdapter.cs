...
namespace DatabaseSchemaReader.ProviderSchemaReaders.Adapters
{
    class SqlServerAdapter : ReaderAdapter
    {
        ...
        {
            return new ViewSources(Owner, viewName, AdditionalViewSourceProperties)
                .Execute(DbConnection);
        }
        ...
        {
            return new DefaultConstraints(Owner, tableName, AdditionalDefaultConstraintProperties)
                .Execute(DbConnection);
        }
        ...
        public override IList<DatabaseStatistics> Statistics(string tableName) 
            {
            return new Statistics(Owner, tableName, AdditionalStatisticsProperties)
                .Execute(DbConnection);
        }
        ...
        {
            return new ProcedureSources(Owner, null, AdditionalProcedureSourceProperties)
                .Execute(DbConnection);
        }
        ...
        public override SerializableAdditionalProperties TopLevelProperties() {
            return new TopLevelProperties(AdditionalTopLevelProperties).Execute(DbConnection);
        }
